...
// Success
// Details 
// Runtime: 16 ms, faster than 100.00% of Go online submissions for Find Root of N-Ary Tree.
// Memory Usage: 9.3 MB, less than 81.25% of Go online submissions for Find Root of N-Ary Tree.
